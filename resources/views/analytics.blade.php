...
<div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
    <div class="md:col-span-2 bg-card border border-border/60 rounded-3xl shadow-lg p-8 transition-all duration-300">
        <div class="flex items-center justify-between mb-8">
            <div>
                <h3 class="text-xl font-extrabold tracking-tight">Device Usage Analysis</h3>
    ...
    <div class="md:col-span-1 space-y-8">
        ...
        <div class="bg-card border border-border/60 rounded-3xl shadow-lg p-8 relative overflow-hidden group transition-all duration-300">
            ...
            @if($highestDevice)
                ...
                <div class="bg-primary text-primary-foreground p-4 rounded-2xl text-center shadow-lg shadow-primary/20">
        ...
        <!-- Insight Box -->
        <div class="bg-gradient-to-br from-primary via-primary/90 to-secondary rounded-3xl shadow-lg p-8 text-white relative overflow-hidden group">
